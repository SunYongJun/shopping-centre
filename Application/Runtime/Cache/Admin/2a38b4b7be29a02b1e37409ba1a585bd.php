					...
					<div class="col-xs-12">
						<div class="table-responsive">
							<table id="sample-table-1" class="table table-striped table-bordered table-hover">
								...
								<form id="allform">
									<tbody>
										<?php if(is_array($brand)): foreach($brand as $key=>$vo): ?><tr>
												<td class="center">
													<label>
												...
												<td>
													<span class="lbl"><?php echo ($vo["brand_name"]); ?></span>
												</td>
												<td>
													<span class="lbl">
														<img src="/newlefeng/Public<?php echo ($vo["brand_logo"]); ?>" alt="品牌logo" height="40"></span>
												</td>
												<td>
													<span class="lbl"><?php echo ($vo["brand_desc"]); ?></span>
												</td>
												<td class="hidden-480"><?php echo ($vo["brand_url"]); ?></td>
												<td class="hidden-480">
													<span><?php echo ($vo["brand_order"]); ?></span>
												</td>

												<td>
													<span class="label label-sm <?php echo ($vo['is_show'] ? 'label-success' : 'label-warning'); ?>"><?php echo ($vo['is_show'] ? '显示' : '不显示'); ?></span>
												</td>
												<td>
													<a href="/newlefeng/index.php/Admin/Brand/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
													|
													<a href="/newlefeng/index.php/Admin/Brand/delete/id/<?php echo ($vo["id"]); ?>">删除</a>
												</td>
	...
	<script>
		$(function() {
			...
			$('#delall').bind('click',function() {
				...
				$.post('/newlefeng/index.php/Admin/Brand/delall',data,function(data) {				
					if(data){
						layer.msg(data,3,function(){
							location.reload();
						});
					}else{
