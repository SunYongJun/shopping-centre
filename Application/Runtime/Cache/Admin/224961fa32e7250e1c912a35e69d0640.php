...
<li class="active"><a href="/newlefeng/index.php/Admin/ADminUser/rule">浏览规则</a></li>
					...
					<div class="table-responsive">
						<table id="sample-table-1" class="table table-striped table-bordered table-hover">
							...
							<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
									...
									<td class="hidden-480">
									<?php if($vo["status"] == 1): ?><span class="label label-sm label-success">启用</span>
									<?php else: ?>
										<span class="label label-sm label-warning">禁用</span><?php endif; ?>
									</td>
									<td>
										<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
											<a class="btn btn-xs btn-info" href="/newlefeng/index.php/Admin/Rule/editRule/id/<?php echo ($vo["id"]); ?>">
			...
			<div id="modal-table" class="modal fade" tabindex="-1">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form class="form-horizontal" role="form" action="/newlefeng/index.php/Admin/Rule/insert" method="post" id="addform">
							<div class="form-group" style="margin-top:20px;">
								<label class="col-sm-5 control-label no-padding-right" for="form-field-1" > 规则功能名称 </label>

								<div class="col-sm-7">
									<input type="text" id="form-field-1" placeholder="请输入规则功能名称。" class="col-xs-10 col-sm-5" name="title" required/><span class="text-danger" style="display:none">请输入正确的名称！</span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" id="form-field-1" placeholder="控制器名。" class="col-xs-10 col-sm-5" name="controller"/><span class="text-danger" style="display:none">请输入正确的控制器名！</span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" id="form-field-1" placeholder="方法名。" class="col-xs-10 col-sm-5" name="action"/><span class="text-danger" style="display:none">请输入正确的方法名！</span>
								</div>
							</div>
...
<script>
	$(function(){
		...
		$('#addtype').click(function(){
			if(title && controller && action){
				
			var data = $('#addform').serialize();
			$.post('/newlefeng/index.php/Admin/Rule/insert',data,function(data){
				if(data.status == 1){
		...
		$('a[del]').click(function(){
			...
			layer.confirm('确定删除吗？',function(){
				$.post('/newlefeng/index.php/Admin/Rule/delRule',id,function(data){
					if(data == 1){
		...
		$('#delall').click(function(){
			...
			$.post('/newlefeng/index.php/Admin/Rule/delRuleAll',data,function(data){
				if(data == 1){
