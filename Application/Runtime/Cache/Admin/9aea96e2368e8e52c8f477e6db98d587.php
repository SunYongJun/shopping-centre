...
<li class="active"><a href="/newlefeng/index.php/Admin/ArticleType/index">友情链接</a></li>
	...
	<div class="row">
		<div class="col-xs-12">
					...
					<div class="table-responsive">
						<table id="sample-table-1" class="table table-striped table-bordered table-hover">
							...
							<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
									...
									<td><?php if(($vo["link_type"]) == "1"): ?>文字链接<?php else: ?>图片链接<?php endif; ?></td>
									<td>
										<?php if(empty($vo["link_logo"])): ?>没有添加LOGO
										<?php else: ?>
											<img src="/newlefeng/Public/<?php echo ($vo["link_logo"]); ?>" height="30" alt=""><?php endif; ?>
									</td>
									...
									<td>
										...
										<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
											<a class="btn btn-xs btn-info" href="/newlefeng/index.php/Admin/Flink/edit/id/<?php echo ($vo["id"]); ?>">
			...
			<h4 class="pink">
				...
				<a href="/newlefeng/index.php/Admin/Flink/add" role="button" class="green" data-toggle="modal"> 添加友情链接 </a>
			</h4>
			...
			<div id="modal-table" class="modal fade" tabindex="-1">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form class="form-horizontal" role="form" action="/newlefeng/index.php/Admin/Flink/insert" method="post" id="addform">
	...
	$(function(){
		...
		$('a[del]').click(function(){
			...
			layer.confirm('确定删除吗？',function(){
				$.post('/newlefeng/index.php/Admin/Flink/del',id,function(data){
					if(data == 1){
		...
		$('#delall').click(function(){
			...
			$.post('/newlefeng/index.php/Admin/Flink/delall',data,function(data){
				if(data == 1){
