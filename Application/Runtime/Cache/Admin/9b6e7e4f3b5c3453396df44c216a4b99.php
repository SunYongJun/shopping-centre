...
<li class="active"><a href="/newlefeng/index.php/Admin/AdminUser/changepwd">管理员列表</a></li>
				...
				<table id="sample-table-1" class="table table-striped table-bordered table-hover">
					...
					<tbody>
						<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
								...
								<td><?php echo ($vo["admin_login"]); ?></td>
								<td><?php echo (long2ip($vo["admin_ip"])); ?></td>
								<td><?php echo ($vo["level_name"]); ?></td>
							<td>
								<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">

							<a class="btn btn-xs btn-info" title="修改" href="/newlefeng/index.php/Admin/AdminUser/save/id/<?php echo ($vo["id"]); ?>">
								<i class="icon-edit bigger-120"></i>
							</a>
						
							<a class="btn btn-xs btn-danger" del="<?php echo ($vo["id"]); ?>" title="删除">
	...
	$(function(){
		$('a[del]').click(function(){
			...
			layer.confirm('您确定要删除吗？',function(){
				$.post('/newlefeng/index.php/Admin/AdminUser/del',id,function(data){
					if(data == 1){
		...
		$('#delall').click(function(){
			...
			$.post('/newlefeng/index.php/Admin/AdminUser/delall',data,function(data){
				if(data == 1){
