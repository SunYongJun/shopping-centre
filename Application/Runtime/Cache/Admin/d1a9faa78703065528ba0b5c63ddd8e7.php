...
<li class="active"><a href="/newlefeng/index.php/Admin/Ad/index">广告管理</a></li>
	...
	<div class="row">
		<div class="col-xs-12">
					...
					<div class="table-responsive">
						<table id="sample-table-1" class="table table-striped table-bordered table-hover">
							...
							<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
									...
									<td><?php echo ($vo["ad_position"]); ?></td>
									<td><?php echo ($vo["ad_link"]); ?></td>
									<td>
										<img src="/newlefeng/Public/<?php echo ($vo["ad_picture"]); ?>"  alt="" width="200" height="30">
									</td>
									...
									<td>
										...
										<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
											<a class="btn btn-xs btn-info" href="/newlefeng/index.php/Admin/Ad/edit/id/<?php echo ($vo["id"]); ?>">
			...
			<h4 class="pink">
				...
				<a href="/newlefeng/index.php/Admin/Ad/add" role="button" class="green" data-toggle="modal"> 添加广告 </a>
			</h4>
			...
			<div id="modal-table" class="modal fade" tabindex="-1">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form class="form-horizontal" role="form" action="/newlefeng/index.php/Admin/Ad/insert" method="post" id="addform">
...
<script>
	$(function(){
		...
		$('#addtype').click(function(){
			...
			$.post('/newlefeng/index.php/Admin/Ad/insert',data,function(data){
				if(data == 1){
		...
		$('a[del]').click(function(){
			...
			layer.confirm('确定删除吗？',function(){
				$.post('/newlefeng/index.php/Admin/Ad/del',id,function(data){
					if(data == 1){
		...
		$('#delall').click(function(){
			...
			$.post('/newlefeng/index.php/Admin/Ad/delall',data,function(data){
				if(data == 1){
