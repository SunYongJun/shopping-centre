							...
							<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
									...
									<td>
										...
										<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
											<a class="btn btn-xs btn-info" href="/newlefeng/index.php/Admin/ArticleType/edit/id/<?php echo ($vo["id"]); ?>">
			...
			<div id="modal-table" class="modal fade" tabindex="-1">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form class="form-horizontal" role="form" action="/newlefeng/index.php/Admin/ArticleType/insert" method="post" id="addform">
...
<script>
	$(function(){
		...
		$('a[del]').click(function(){
			...
			layer.confirm('删除分类将删除分类下所有文章，是否删除？',function(){
				$.post('/newlefeng/index.php/Admin/ArticleType/del',id,function(data){
					console.log(data);
					if(data == 1){
		...
		$('#delall').click(function(){
			...
			$.post('/newlefeng/index.php/Admin/ArticleType/delall',data,function(data){
				if(data == 1){
