	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form class="form-horizontal" role="form" action="/newlefeng/index.php/Admin/Goods/save" method="post" enctype="multipart/form-data" id="form">
						...
						<div class="col-sm-9">
							...
							<div class="btn-group">
								<div data-toggle="dropdown" class="drop_down btn btn-white dropdown-toggle" style="border:1px solid #ccc;width:250px;">
									<span class="dropdown_sp"><?php echo ($iddata["type_name"]); ?></span> <i class="icon-angle-down icon-on-right "></i>
									<input type="hidden" name="type_id" value="<?php echo ($iddata["type_id"]); ?>" sel="select"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							...
							<div class="btn-group">
								<div data-toggle="dropdown" class="drop_down btn btn-white dropdown-toggle" style="border:1px solid #ccc;width:250px;">
									<span class="dropdown_sp"><?php echo ($iddata["brand_name"]); ?></span>
									<i class="icon-angle-down icon-on-right "></i>
									<input type="hidden" name="brand_id" value="<?php echo ($iddata["brand_id"]); ?>" sel="select"></div>

								<ul class="dropdown-menu dropdown-success pull-left dropdown_ul" id="brandul">
									<?php if(is_array($brand)): foreach($brand as $key=>$vo): ?><li  value="<?php echo ($vo["id"]); ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="form-field-1"  class="col-xs-10 col-sm-5" name="goods_name" value="<?php echo ($iddata["goods_name"]); ?>" required/><span></span>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="form-field-2"  class="col-xs-10 col-sm-5" name="goods_keywords" value="<?php echo ($iddata["goods_keywords"]); ?>"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="number" id="form-field-3"  class="col-xs-10 col-sm-5" name="goods_number" value="<?php echo ($iddata["goods_number"]); ?>"/>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text"  class="col-xs-10 col-sm-5" name="goods_weight" id="form-field-4" value="<?php echo ($iddata["goods_weight"]); ?>"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text"  class="col-xs-10 col-sm-5 required" name="goods_price" id="form-field-5" value="<?php echo ($iddata["goods_price"]); ?>" required />
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-7">商品折扣</label><span></span>

						<div class="col-sm-9">
							<input type="text"  class="col-xs-10 col-sm-5" name="goods_sale" id="form-field-7" value="<?php echo ($iddata["goods_sale"]); ?>" /><span> </span>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="col-xs-10 col-sm-5" name="goods_brief" id="form-field-10" value="<?php echo ($iddata["goods_brief"]); ?>" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="form-field-11" placeholder="商品赠送花粉数 " class="col-xs-10 col-sm-5" name="goods_coin" value="<?php echo ($iddata["goods_coin"]); ?>" />
						</div>
					</div>
						...
						<div class="col-sm-9">
							<div class="col-xs-12 col-sm-6">
								<div class="control-group">
									...
									<label>
										<input name="is_on_sale" type="radio" class="ace" value="1"  <?php echo ($iddata[is_on_sale] ? 'checked' : ''); ?> />
										<span class="lbl">是</span>
									</label>

									<label>
										<input name="is_on_sale" type="radio" class="ace" value="0"  <?php echo ($iddata[is_on_sale] ? '' : 'checked'); ?> />
					...
					<div class="form-group" id="logo">
						...
						<div class="col-sm-9">
							<!-- uploadify上传插件 -->
							<div id="imgs">
								<img src="/newlefeng/Public<?php echo ($iddata["goods_img"]); ?>" alt="" width="200"></div>
							<input id="file_upload" name="goods_img" type="file" value="<?php echo ($iddata["goods_img"]); ?>" />
							<!-- uploadify上传插件 -->
							<input type="hidden" value="<?php echo ($iddata["goods_img"]); ?>" id="uplogo" name="goods_img">
							<!-- 上传的图片地址放到这里面 -->
						</div>
					</div>
					...
					<div class="form-group">
						...
						<textarea class="col-sm-9 control-label no-padding-right" id="container" name="goods_desc"><?php echo ($iddata["goods_desc"]); ?></textarea>
					</div>
        ...
        $(function() {
        	...
        	$('li[type="type"]').bind('click',function() {
        		if(!$('input[name="type_id"]').val()) {
        			$('#typeid').css('color','red').html('请选择二级分类（提示：如果没有二级分类，请先添加分类）');
        			type = false;
        		}else{
        			$('#typeid').html('');
        			type = true;
        	...
        	$('li[brand]').bind('click',function() {
        		if(!$('input[name="brand_id"]').val()){
        			$('#brandid').css('color','red').html('请选择品牌（提示：如果没有品牌，请先添加品牌）');
        			brand = false;
        		}else{
        			$('#brandid').html('');
        			brand = true; 
