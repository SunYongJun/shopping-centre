...
<li class="active"><a href="/newlefeng/index.php/Admin/ADminUser/group">管理员组</a></li>
					...
					<div class="table-responsive">
						<table id="sample-table-1" class="table table-striped table-bordered table-hover">
							...
							<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
									...
									<td><a href="/newlefeng/index.php/Admin/Rule/role/gid/<?php echo ($vo["id"]); ?>">分配权限</a></td>
									<td>
										<?php if($vo["id"] != 1): ?><div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
...
<script>
	$(function(){
		...
		$('a[del]').click(function(){
			...
			$.get('/newlefeng/index.php/Admin/Rule/delGroup','id='+id,function(data){
				if(data == 1){
		...
		$('#addtype').click(function(){
			...
			$.post('/newlefeng/index.php/Admin/Rule/insertGroup',data,function(data){
				if(data == 1){
