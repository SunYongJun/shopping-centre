...
<li class="active"><a href="/newlefeng/index.php/Admin/Flink/index">友情链接列表</a></li>
<li class="active"><a href="/newlefeng/index.php/Admin/Flink/add">添加友情链接</a></li>
...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" action="/newlefeng/index.php/Admin/Flink/insert" enctype="multipart/form-data" role="form" method="post" id="addform">
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 友情链接名字 </label>

					<div class="col-sm-9">
						<input type="text" id="form-field-1" placeholder="请输入友情链接名字。" class="col-xs-10 col-sm-5" name="link_name" required/><span class="text-danger" style="display:none">请输入友情链接名字！</span>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="url" id="form-field-1" placeholder="请输入友情链接地址。" class="col-xs-10 col-sm-5" name="link_url" required/><span class="text-danger" style="display:none">请输入正确链接地址！</span>
					</div>
				</div>
				<div class="form-group">
	...
	$(function(){
		...
		$('#file_upload').uploadify({
	        ...
	        'uploader' : '/newlefeng/index.php/Admin/Flink/myupload',
	        'buttonText' : 'LOGO上传',
    	...
    	$('#addtype').click(function(){
    		...
    		if(name && link && picture){
    			...
    			layer.msg('请正确填写内容！',2,3);
    		}
    	})
		/*$('#addtype').click(function(){

			var data = $('#addform').serialize();
			$.post('/newlefeng/index.php/Admin/Flink/insert',data,function(data){
				if(data == 1){
					// alert('success');
					layer.msg('添加成功！',2,1);
				}else{
