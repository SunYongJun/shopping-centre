								...
								<form id="allform">
									<tbody>
										<?php if(is_array($type)): foreach($type as $key=>$vo): ?><tr>
												...
												<td>
													<a href="/newlefeng/index.php/Admin/Goods/giftadd/id/<?php echo ($vo["id"]); ?>">添加赠品</a>
												</td>

												<td>
													<a href="/newlefeng/index.php/Admin/Goods/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
													|
													<a href="/newlefeng/index.php/Admin/GoodsGallery/index/id/<?php echo ($vo["id"]); ?>">查看相册</a>
													|
													<a href="/newlefeng/index.php/Admin/Sale/index/id/<?php echo ($vo["id"]); ?>">秒杀</a>
													|
													<a href="/newlefeng/index.php/Admin/Goods/recycle/id/<?php echo ($vo["id"]); ?>">删除</a>
												</td>
	...
	<script>
		$(function() {
			...
			$('#delall').bind('click',function() {
				...
				$.post('/newlefeng/index.php/Admin/Goods/recycleall',data,function(data) {			
