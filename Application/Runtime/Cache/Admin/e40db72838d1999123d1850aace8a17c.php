...
<li class="active"><a href="/newlefeng/index.php/Admin/Order/index">订单管理</a></li>
...
<div class="page-content">
	<div class="page-header">
		<h1 id="dianji">
			...
			<small>
				<i class="icon-double-angle-right"></i>
				订单号：<?php echo ($_GET['acti']); ?> <?php if($info["is_delete"] == 1): ?>&nbsp;&nbsp;<span class="text-warning bigger-110 orange"><i class="icon-warning-sign"></i>该订单已删除！</span><?php endif; ?>
				</small>
		</h1>
	</div><!-- /.page-header -->
	<div class="col-xs-12">
			...
			<div class="tab-content">
				<div id="home" class="tab-pane active">
					<table id="sample-table-1" class="table table-bordered">
						...
						<tr class="bordered">
							...
							<td class="col-xs-5"><?php echo ($_GET['acti']); ?></td>
							<td class="col-xs-1 text-right blue"> 订单状态 </td>
							<td class="col-xs-5"><?php echo ($info["status"]); ?></td>
						</tr>
						<tr class="bordered">
							<td class="col-xs-1 text-right blue"> 下单人 </td>
							<td class="col-xs-5"><?php echo ($user["user_email"]); ?></td>
							<td class="col-xs-1 text-right blue"> 下单时间 </td>
							<td class="col-xs-5"><?php echo (date('Y-m-d H:i:s',$info["order_time"])); ?></td>
						</tr>
						<tr class="bordered">
							<td class="col-xs-1 text-right blue"> 支付方式 </td>
							<td class="col-xs-5"><?php echo ($pay["pay_name"]); ?></td>
							<td class="col-xs-1 text-right blue"> 配送方式 </td>
							<td class="col-xs-5"><?php echo ($shipping["shipping_name"]); ?></td>
						</tr>
						
						<tr class="bordered">
							<td class="col-xs-1 text-right blue"> 发货时间 </td>
							<td class="col-xs-5"> 
							<?php if(!empty($info['action_time'])): echo (date("Y-m-d H:i:s",$info["action_time"])); ?> 
							<?php else: ?>
							待发货<?php endif; ?>
							</td>
							<td class="col-xs-1 text-right blue"> 用户留言 </td>
							<td class="col-xs-11" colspan="3"><?php echo ($info["order_message"]); ?></td>
						</tr>
						<tr class="bordered">
							<td class="col-xs-1 text-right blue"> 订单金额 </td>
							<td class="col-xs-11" colspan="3"><?php echo ($info["action_count"]); ?></td>
						</tr>
					</table>
					...
					<table class="table table-bordered">
						...
						<tr class="bordered">
							...
							<td class="col-xs-5"><?php echo ($address["true_name"]); ?></td>
							<td class="col-xs-1 text-right blue"> 电子邮件 </td>
							<td class="col-xs-5"><?php echo ($address["address_email"]); ?></td>
						</tr>
						<tr class="bordered">
							<td class="col-xs-1 text-right blue"> 最佳送货时间 </td>
							<td class="col-xs-5"> <?php echo ($info["delivery"]); ?> </td>
							<td class="col-xs-1 text-right blue"> 邮编 </td>
							<td class="col-xs-5"><?php echo ($address["address_zip"]); ?></td>
						</tr>
						<tr class="bordered">
							<td class="col-xs-1 text-right blue"> 电话 </td>
							<td class="col-xs-5">2014234234</td>
							<td class="col-xs-1 text-right blue"> 手机 </td>
							<td class="col-xs-5"><?php echo ($address["address_phone"]); ?></td>
						</tr>
						<tr class="bordered" >
							<td class="col-xs-1 text-right blue"> 详细地址 </td>
							<td class="col-xs-5" colspan="3"><?php echo ($address["address_province"]); ?>，<?php echo ($address["address_city"]); ?>，<?php echo ($address["address_county"]); ?>，<?php echo ($address["address_info"]); ?></td>
						</tr>
					</table>
				</div>
				...
				<div id="shop" class="tab-pane">
					<table class="table table-bordered">
						...
						<?php if(is_array($goods)): foreach($goods as $key=>$vgoods): ?><tr class="bordered text-center">
							<td> 1 </td>
							<td><?php echo ($vgoods["goods_name"]); ?><img src="/newlefeng/Public/<?php echo ($vgoods["goods_img"]); ?>" height="30">
							<?php if(!empty($vgoods['gift'])): ?><p class="text-success">赠品：<?php echo ($vgoods['gift']['gift_name']); ?><b class="text-danger">￥<?php echo ($vgoods['gift']['gift_price']); ?></b></p></td><?php endif; ?>
							<td> <?php echo ($vgoods["goods_sn"]); ?> </td>
							<td> <?php echo ($vgoods["goods_price"]); ?> </td>
							<td><?php echo ($vgoods["num"]); ?></td>
							<td><?php echo ($vgoods["sum"]); ?></td>
						</tr><?php endforeach; endif; ?>
					</table>
				</div>
			</div>
		</div>
		<a href="/newlefeng/index.php/Admin/Order/index" style="margin:10px 0px;" class="btn btn-sm btn-warning">返回订单详细列表</a>
