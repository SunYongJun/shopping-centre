...
<li class="active"><a href="/newlefeng/index.php/Admin/PayType/index">支付方式管理</a></li>
<li class="active"><a href="/newlefeng/index.php/Admin/PayType/add">添加支付方式</a></li>
...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" action="/newlefeng/index.php/Admin/PayType/insert" enctype="multipart/form-data" role="form" method="post" id="addform">
	...
	$(function(){
		...
		$('#file_upload').uploadify({
	        ...
	        'uploader' : '/newlefeng/index.php/Admin/PayType/myupload',
	        'buttonText' : 'LOGO上传',
	        'onUploadSuccess' : function(file, data, response) {
	        	img = "<img height='40px' src='/newlefeng/Public/"+data+"'>";
	        	$('#imgs').html(img);
	        	$('#uplogo').val(data);
        	}
    	});
		...
		/*$('#addtype').click(function(){
			...
			$.post('/newlefeng/index.php/Admin/PayType/insert',data,function(data){
				if(data == 1){
					// alert('success');
					layer.msg('添加成功！',2,1);
				}else{
