	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form class="form-horizontal" role="form" action="/newlefeng/index.php/Admin/ShopType/insert" method="post" id="form">
						...
						<div class="col-sm-9">
							...
							<div class="btn-group">
								...
								<ul class="dropdown-menu dropdown-success pull-left dropdown_ul" id="">
									...
									<?php if(is_array($type)): foreach($type as $key=>$vo): ?><li  value="<?php echo ($vo["id"]); ?>">
