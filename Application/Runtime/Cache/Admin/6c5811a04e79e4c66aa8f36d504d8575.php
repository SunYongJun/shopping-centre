...
<li class="active"><a href="/newlefeng/index.php/Admin/ArticleType/index">支付方式</a></li>
	...
	<div class="row">
		<div class="col-xs-12">
					...
					<div class="table-responsive">
						<table id="sample-table-1" class="table table-striped table-bordered table-hover">
							...
							<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
									...
									<td><?php if(!empty($vo["pay_logo"])): ?><img src="/newlefeng/Public/<?php echo ($vo["pay_logo"]); ?>" height="30" alt=""><?php endif; ?>
									</td>
									...
									<td>
										<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
											<a class="btn btn-xs btn-info" href="/newlefeng/index.php/Admin/PayType/edit/id/<?php echo ($vo["id"]); ?>">
			...
			<h4 class="pink">
				...
				<a href="/newlefeng/index.php/Admin/PayType/add" role="button" class="green" data-toggle="modal"> 添加支付方式 </a>
			</h4>
		</div><!-- /.col -->
	</div><!-- /.row -->
</div>
	...
	$(function(){
		...
		$('a[del]').click(function(){
			...
			layer.confirm('确定删除吗？',function(){
				$.post('/newlefeng/index.php/Admin/PayType/del',id,function(data){
					if(data == 1){
		...
		$('#delall').click(function(){
			...
			$.post('/newlefeng/index.php/Admin/PayType/delall',data,function(data){
				if(data == 1){
