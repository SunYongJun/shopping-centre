...
<html lang="en">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form class="form-horizontal" role="form" action="/newlefeng/index.php/Admin/Brand/insert" method="post" enctype="multipart/form-data" id="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="url" id="form-field-2"  class="col-xs-10 col-sm-5" name="brand_url" /><span></span>
						</div>
					</div>
	...
	$(function() {
		...
		$('#file_upload').uploadify({
		        ...
		        'uploader' : '/newlefeng/index.php/Admin/Brand/myupload',
		        'buttonText' : 'LOGO上传',
