...
<li class="active"><a href="/newlefeng/index.php/Admin/AdminUser/role">角色管理</a></li>
...
<div class="page-content">
	...
	<form action="/newlefeng/index.php/Admin/Rule/edit" method="post">
	<input type="hidden" name="id" value="<?php echo ($_GET['gid']); ?>">
	<div class="col-xs-12 col-sm-12">
		<?php if(is_array($list)): foreach($list as $key=>$vo): ?><label class="col-xs-3 chk">
			<input name="ids[]" class="ace ace-checkbox-2" type="checkbox" value="<?php echo ($vo["id"]); ?>" <?php echo ($vo["chk"]); ?>>
