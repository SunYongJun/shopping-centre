...
<li class="active"><a href="/newlefeng/index.php/Admin/Shipping/index">配送方式</a></li>
...
<div class="page-content">
	...
	<div class="col-xs-4 col-sm-5 text-right" style="margin-bottom:10px">
		<div class="input-group">
			<input type="text" class="form-control search-query" placeholder="输入关键词" name="keywords">
	...
	<div class="row">
		<div class="col-xs-12">
					...
					<div class="table-responsive">
						<table id="sample-table-1" class="table table-striped table-bordered table-hover">
							...
							<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
									...
									<td><?php echo ($vo["shipping_desc"]); ?></td>
									<td><?php echo ($vo["shipping_money"]); ?></td>
									<td class="hidden-480">
									<?php if($vo["is_status"] == 1): ?><span class="label label-sm label-success">启用</span>
									<?php else: ?>
									...
									<td>
										...
										<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
											<a class="btn btn-xs btn-info" href="/newlefeng/index.php/Admin/Shipping/edit/id/<?php echo ($vo["id"]); ?>">
			...
			<h4 class="pink">
				...
				<a href="/newlefeng/index.php/Admin/Shipping/add" role="button" class="green" data-toggle="modal"> 添加配送方式 </a>
			</h4>
			...
			<div id="modal-table" class="modal fade" tabindex="-1">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form class="form-horizontal" role="form" action="/newlefeng/index.php/Admin/Shipping/insert" method="post" id="addform">
...
<script>
	$(function(){
		...
		$('#addtype').click(function(){
			...
			$.post('/newlefeng/index.php/Admin/Shipping/insert',data,function(data){
				if(data == 1){
		...
		$('a[del]').click(function(){
			...
			layer.confirm('确定删除吗？',function(){
				$.post('/newlefeng/index.php/Admin/Shipping/del',id,function(data){
					if(data == 1){
		...
		$('#delall').click(function(){
			...
			$.post('/newlefeng/index.php/Admin/Shipping/delall',data,function(data){
				if(data == 1){
