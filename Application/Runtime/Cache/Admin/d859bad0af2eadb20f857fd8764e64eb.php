...
<li class="active"><a href="/newlefeng/index.php/Admin/ShopConfig/index">系统设置</a></li>
<li class="active"><a href="/newlefeng/index.php/Admin/ShopConfig/index">商城设置</a></li>
...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" action="/newlefeng/index.php/Admin/ShopConfig/insert" enctype="multipart/form-data" role="form" method="post" id="addform">
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 商城名称 </label>

					<div class="col-sm-9">
						<input type="text" id="form-field-1" placeholder="请输入商城名称名字。" class="col-xs-10 col-sm-5" name="shop_name" required value="<?php echo ($shopset["shop_name"]); ?>" />
					</div>
				...
				<div class="form-group" id="logo">
					<label class="col-sm-3 control-label no-padding-right"> 商城LOGO </label>
					<div class="col-sm-9">
						<!-- uploadify上传插件 -->
						<div id="imgs">
						<?php if(!empty($shopset["shop_logo"])): ?><img src="/newlefeng/Public/<?php echo ($shopset["shop_logo"]); ?>" alt="" height="30"><?php endif; ?>
						</div>
						<input id="file_upload" name="file_upload" type="file" multiple="true" value="" />
						<!-- uploadify上传插件 -->
						<input type="hidden" value="<?php echo ($shopset["shop_logo"]); ?>" id="uplogo" name="shop_logo" value="shop_logo">
						<!-- 上传的图片地址放到这里面 -->
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-2" > 商城关键字 </label>

					<div class="col-sm-9">
						<input type="text" id="form-field-2" placeholder="请输入商城关键字。" class="col-xs-10 col-sm-5" name="shop_key" value="<?php echo ($shopset["shop_key"]); ?>"/>
					</div>
					<span class="col-xs-10 col-sm-8">
						<i class="icon-angle-right bigger-110"></i>
						<span class="text-warning">便于搜索引擎查找，输入多个请逗号分开。</span>
					</span>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-3" > 商城描述 </label>

					<div class="col-sm-9">
						<input type="text" id="form-field-3" placeholder="请输入商城关键字。" class="col-xs-10 col-sm-5" name="shop_desc" value="<?php echo ($shopset["shop_desc"]); ?>"/>
					</div>
					<span class="col-xs-10 col-sm-5">
						<i class="icon-angle-right bigger-110"></i>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-4" > 商城所在地区 </label>

					<div class="col-sm-9">
						<input type="text" id="form-field-4" placeholder="请输入商城关键字。" class="col-xs-10 col-sm-5" name="shop_area" value="<?php echo ($shopset["shop_area"]); ?>"/>
					</div>
					<span class="col-xs-10 col-sm-5">
						<i class="icon-angle-right bigger-110"></i>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-5" > 商城详细地址 </label>

					<div class="col-sm-9">
						<input type="text" id="form-field-5" placeholder="请输入商城关键字。" class="col-xs-10 col-sm-5" name="shop_address" value="<?php echo ($shopset["shop_address"]); ?>"/>
					</div>
					<span class="col-xs-10 col-sm-5">
						<i class="icon-angle-right bigger-110"></i>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-6" > 商城Email </label>

					<div class="col-sm-9">
						<input type="text" id="form-field-6" placeholder="请输入商城Email地址。" class="col-xs-10 col-sm-5" name="shop_mail" value="<?php echo ($shopset["shop_mail"]); ?>"/>
					</div>
					<span class="col-xs-10 col-sm-5">
						<i class="icon-angle-right bigger-110"></i>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-7" > 商城电话 </label>

					<div class="col-sm-9">
						<input type="text" id="form-field-7" placeholder="请输入商城关键字。" class="col-xs-10 col-sm-5" name="shop_phone" value="<?php echo ($shopset["shop_phone"]); ?>"/>
					</div>
					<span class="col-xs-10 col-sm-5">
						<i class="icon-angle-right bigger-110"></i>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-8"> 网站状态 </label>
					<div class="col-xs-9">
						<div class="radio">
							<label>
							<input id="form-field-8" name="is_status" type="radio" class="ace" value="1" <?php if($shopset["is_status"] == 1): ?>checked<?php endif; ?>>
							<span class="lbl">开启</span>
							</label>
							<label>
							<input name="is_status" type="radio" class="ace" value="0" <?php if($shopset["is_status"] == 0): ?>checked<?php endif; ?>>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-9"> 网站是否可以注册 </label>
					<div class="col-xs-8">
						<div class="radio">
							<label>
							<input id="form-field-9" name="is_reg" type="radio" class="ace" value="1" <?php if($shopset["is_reg"] == 1): ?>checked<?php endif; ?>>
							<span class="lbl">可以</span>
							</label>
							<label>
							<input name="is_reg" type="radio" class="ace" value="0" <?php if($shopset["is_reg"] == 0): ?>checked<?php endif; ?>>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-10" > 商城的备案信息 </label>
					<div class="col-sm-9">
						<input type="text" id="form-field-10" placeholder="请输入简单描述。" class="col-xs-10 col-sm-5" name="shop_icp" value="<?php echo ($shopset["shop_icp"]); ?>" />
					</div>
					<span class="col-xs-10 col-sm-5">
							<i class="icon-angle-right bigger-110"></i>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-11"> 注册是否发送邮件 </label>
					<div class="col-xs-3">
						<div class="radio">
							<label>
							<input id="form-field-11" name="is_email" type="radio" class="ace" value="1" <?php if($shopset["is_email"] == 1): ?>checked<?php endif; ?>>
							<span class="lbl">是</span>
							</label>
							<label>
							<input name="is_email" type="radio" class="ace" value="0" <?php if($shopset["is_email"] == 0): ?>checked<?php endif; ?>>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-12"> 评价是否需要审核 </label>
					<div class="col-xs-3">
						<div class="radio">
							<label>
							<input name="is_message" type="radio" class="ace" value="1" <?php if($shopset["is_message"] == 1): ?>checked<?php endif; ?>>
							<span class="lbl">是</span>
							</label>
							<label>
							<input name="is_message" type="radio" class="ace" value="0" <?php if($shopset["is_message"] == 0): ?>checked<?php endif; ?>>
							<span class="lbl">否</span>
							</label>
						</div>
					</div>
	...
	$(function(){
		var img = '';
		// alert('<?php echo U("Flink/myupload");?>');
		$('#file_upload').uploadify({
	        'swf' : '/newlefeng/Public/uploadify/uploadify.swf',
	        'uploader' : '/newlefeng/index.php/Admin/ShopConfig/myupload',
	        'buttonText' : '上传LOGO',
	        'onUploadSuccess' : function(file, data, response) {
	        	img = "<img height='30px' src='/newlefeng/Public/"+data+"'>";
	        	$('#imgs').html(img);
	        	$('#uplogo').val(data);
        	}
    	});
		$('#addtype').click(function(){
			...
			$.post('/newlefeng/index.php/Admin/ShopConfig/insert',data,function(data){
				if(data == 1){
					// alert('success');
