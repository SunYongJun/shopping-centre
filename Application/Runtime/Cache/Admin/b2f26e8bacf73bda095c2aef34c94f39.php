...
<li class="active"><a href="/newlefeng/index.php/Admin/AdminUser/index">权限设置</a></li>
<li class="active"><a href="/newlefeng/index.php/Admin/AdminUser/changepwd">修改密码</a></li>
...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" action="/newlefeng/index.php/Admin/AdminUser/changes" enctype="multipart/form-data" role="form" method="post" id="cha">
	...
	$(function(){
		...
		$('#oldpwd').blur(function(){
			var pwd = $(this).val();
			if(pwd.length==0){
				$('#warning_one').html('<img class="gou5" src="/newlefeng/Public/home/images/gou5.gif">密码不能为空');
			}else{
				
				$.post('/newlefeng/index.php/Admin/AdminUser/changepwds',{userpwd:pwd},function(data){
					if(data){
						oldpwd = true;
						$('#warning_one').html('<img src="/newlefeng/Public/home/images/gou4.gif">');
					}else{
						$('#warning_one').html('<img class="gou5" src="/newlefeng/Public/home/images/gou5.gif">密码不正确');
					}
				})
			}
		})
		...
		$('#newpwd').blur(function(){
			...
			if(newpass.length < 6 || newpass.length >16){
				$('#warning_two').html('<img class="gou5" src="/newlefeng/Public/home/images/gou5.gif">请输入6-16位密码');
			}else{
				newpwd = true;
				$('#warning_two').html('<img src="/newlefeng/Public/home/images/gou4.gif">');
			}	
		})
		$('#renewpwd').blur(function(){
			...
			if(renewpass != newpass){
				$('#warning_three').html('<img class="gou5" src="/newlefeng/Public/home/images/gou5.gif">两次密码不一致');
				return;
			}else{
				repwd = true;
				$('#warning_three').html('<img src="/newlefeng/Public/home/images/gou4.gif">');
		...
		$('#saveit').bind('click',function(){
			...
			if(oldpwd && newpwd && repwd){
				var newpass = $('#newpwd').val();
				$.post('/newlefeng/index.php/Admin/AdminUser/sureChange',{newpwd:newpass},function(data){
					if(data){
						layer.msg('修改成功',1,1);
