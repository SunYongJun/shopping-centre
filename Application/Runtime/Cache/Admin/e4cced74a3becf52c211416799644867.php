...
<li class="active"><a href="/newlefeng/index.php/Admin/Ad/index">广告列表</a></li>
<li class="active"><a href="/newlefeng/index.php/Admin/Ad/add">添加广告</a></li>
...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" action="/newlefeng/index.php/Admin/Ad/insert" enctype="multipart/form-data" role="form" method="post" id="addform">
	...
	$(function(){
		...
		$('#file_upload').uploadify({
	        ...
	        'uploader' : '/newlefeng/index.php/Admin/Ad/myupload',
	        'buttonText' : '图片上传',
