...
<html lang="en">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form class="form-horizontal" role="form" action="/newlefeng/index.php/Admin/Gift/insert" method="post" enctype="multipart/form-data" id="form">

					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1">赠品名称</label>

						<div class="col-sm-9">
							<input type="text" id="form-field-1"  class="col-xs-10 col-sm-5" name="gift_name" /><span></span>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="form-field-2"  class="col-xs-10 col-sm-5" name="gift_price" /><span></span>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="number" id="form-field-3"  class="col-xs-10 col-sm-5" name="gift_count" /><span></span>
	...
	$(function() {
		...
		$('#file_upload').uploadify({
		        ...
		        'uploader' : '/newlefeng/index.php/Admin/Gift/myupload',
		        'buttonText' : 'LOGO上传',
